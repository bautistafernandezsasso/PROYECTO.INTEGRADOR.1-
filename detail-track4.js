...
fetch (apiPlaylist)                                           
  ...
  fotoAr4.innerHTML +=`
    ...
    botonPlay4.addEventListener('click', function(e){
        e.preventDefault();
        localStorage.setItem('foto4' , JSON.stringify(`${datos.tracks.data[3].album.cover_medium}`));
        localStorage.setItem('nombre4' , JSON.stringify(`${datos.tracks.data[3].title}`));
    })
